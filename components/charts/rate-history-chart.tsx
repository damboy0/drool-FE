...
export function RateHistoryChart({ marketId, days = 90 }: { marketId: string; days?: number }) {
      ...
      <ResponsiveContainer>
        <LineChart data={data} margin={{ top: 12, right: 8, bottom: 0, left: 0 }}>
          ...
          <Tooltip
            ...
            formatter={(value: number, name) => [`${value.toFixed(2)}%`, name === "floatingRate" ? "Floating" : "Fixed"]}
          />
